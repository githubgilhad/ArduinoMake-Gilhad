...
This is copy of [https://github.com/sudar/Arduino-Makefile](https://github.com/sudar/Arduino-Makefile)
with some defaults customised to my PC and some files deleted (examples and other I do not use) - if you want my environment 1:1, use this, if you want full functionality, use Sudar's original. 2025 - Gilhad.
